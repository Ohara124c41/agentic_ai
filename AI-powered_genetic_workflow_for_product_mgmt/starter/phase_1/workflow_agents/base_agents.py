...
class DirectPromptAgent:
    """Agent that forwards user prompts directly to the LLM."""
...
class AugmentedPromptAgent:
    """Agent that responds while assuming a predefined persona."""
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": f"You are {self.persona}. Forget any previous context.",
                },
...
class KnowledgeAugmentedPromptAgent:
    """Agent that must answer using only supplied knowledge."""
...
class EvaluationAgent:
    """Evaluates and iteratively improves a worker agent's output."""
...
class RoutingAgent:
    """Routes prompts to the most appropriate specialized agent."""
    ...
    def route(self, user_input):
        ...
        for agent in self.agents:
            ...
            print(f"[Router] {agent.get('name', 'unknown')} similarity = {similarity:.3f}")
...
class ActionPlanningAgent:
    """Extracts actionable steps from a prompt using supplied knowledge."""
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        system_prompt = (
            ...
            "Only return the steps in your knowledge. Forget any previous context. This is your knowledge: "
            f"{self.knowledge}"
        )
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
